...
char *itmv_test4b() {
  return itmv_test("Test 4b", TEST_CORRECTNESS, !TEST_REACH_CONVERGENCE,
                   16, !UPPER_TRIANGULAR, 2, BLOCK_CYCLIC, 2);
}
...
char *itmv_test7b() {
  return itmv_test("Test 7b", TEST_CORRECTNESS, !TEST_REACH_CONVERGENCE,
                   16, UPPER_TRIANGULAR, 100, BLOCK_MAPPING, 2);
}
...
char *itmv_test_8c() {
  return itmv_test("Test 8c: n=0.5K t=8K block cyclic dense", !TEST_CORRECTNESS,
                   TEST_REACH_CONVERGENCE, 512, !UPPER_TRIANGULAR, 8196,
                   BLOCK_CYCLIC, 16);
}

char *itmv_test_8d() {
  return itmv_test("Test 8d: n=0.5K t=8K block cyclic triangle", !TEST_CORRECTNESS,
                   TEST_REACH_CONVERGENCE, 512, UPPER_TRIANGULAR, 8196,
                   BLOCK_CYCLIC, 16);
}
...
void run_all_tests(void) {
  ...
  // mu_run_test(itmv_test_8c);
  // mu_run_test(itmv_test_8d);
